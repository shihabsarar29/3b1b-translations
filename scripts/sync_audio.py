...
if __name__ == "__main__":
    ...
    translations_paths = [
        Path("/Users/shihab/Documents/3b1b/captions/2024/shorts/mandelbrot/spanish/sentence_translations.json")
    ]

    music_paths = [
        Path("/Users/shihab/Downloads/only_music.mp3")
    ]

    files_to_delete = []

    for i, translations_path in enumerate(translations_paths):
